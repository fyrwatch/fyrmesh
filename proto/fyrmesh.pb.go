...
var file_proto_fyrmesh_proto_rawDesc = []byte{
	...
	0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x22, 0x00, 0x32, 0xaf, 0x02, 0x0a, 0x0c,
	...
	0x41, 0x63, 0x6b, 0x6e, 0x6f, 0x77, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x22, 0x00, 0x42, 0x08, 0x5a,
...
var file_proto_fyrmesh_proto_depIdxs = []int32{
	...
	4,  // 13: main.Interface.Read:output_type -> main.ComplexLog
	1,  // 14: main.Interface.Write:output_type -> main.Acknowledge
	2,  // 15: main.Orchestrator.Status:output_type -> main.MeshOrchStatus
	1,  // 16: main.Orchestrator.Connection:output_type -> main.Acknowledge
	3,  // 17: main.Orchestrator.Observe:output_type -> main.SimpleLog
	1,  // 18: main.Orchestrator.Ping:output_type -> main.Acknowledge
	6,  // 19: main.Orchestrator.Nodelist:output_type -> main.NodeList
	1,  // 20: main.Orchestrator.Command:output_type -> main.Acknowledge
